...
class CostCategoryController extends AppController
{

    public string $mainCaption = 'Категории расходов';
    public string $uri = 'cost-category';
    ...
    public function indexAction()
    {
        ...
        $meta = [
            'breadcrumb' => '
                <li class="breadcrumb-item"><a href="/adm/costs">Список расходов</a></li>
                <li class="breadcrumb-item active">' . $this->mainCaption . '</li>',
            'h2' => $this->mainCaption,
